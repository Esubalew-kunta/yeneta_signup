...
import 'package:onboarding/onboardingScreen1.dart';
import 'package:onboarding/onboardingScreen3.dart';
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: Center(
                  child: Image.asset(
                    'assets/img/onboarding2.png', // Add your image here
                    height: 250,
                  ),
                ),
              ),
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => OnboardingScreen3(), // The next screen in the sequence
                    ),
                  );
                },
                child: Text('NEXT'),
